...
if (writer_id == null || guildIdStr == null) {
...
<head>
<meta charset="UTF-8">
<title>글쓰기 - <%=gameDto.getGame_name() %></title>
<style>
...
<%
	...
	<div id="game-title-wrap">
		<div id="game-title">
	<h1 class="game-title"><a href="guild_bbs.jsp?id=<%=guildIdStr%>&pageNum=1"><%=guildDto.getGuildName()%></a></h1>
		</div>
	</div>

	<div id="content-wrap">
<div>
	<form method="post" action="guild_bbs_writePro.jsp" name="write" id="write">
