...
<%@page import="board.GamesCommentDto"%>
...
if (fn.equals("load")) {
	List<GamesCommentDto> articleList = commentDao.getArticles(bbsNum);

	for (int i = 0; i < articleList.size(); i++) {
		commentDto = (GamesCommentDto) articleList.get(i);
		...
		out.write("</div><div class='comment-buttons-wrap'>");
			if (commentDto.getWriterId() == sessionIdx || memberDao.getMemberInfo(sessionIdx, memberDto).getMember_auth() == 2) {
