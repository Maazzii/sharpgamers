...
<body>
	...
	<div id="game-title-wrap">
		<div id="game-title">
	<h1 class="game-title"><%=gameDto.getGame_name()%></h1>
		</div>
	</div>

	<div id="content-wrap">
<div>
	<form method="post" action="game_bbs_updatePro.jsp" name="write" id="write">
...
<div style="margin-top: 100px">
	<form method="post" action="game_bbs_updatePro.jsp">
		...
		<table style="width:480px">
			...
			<tr>
				<td>내용</td>
				<td><textarea name="content" cols="52" rows="15"><%=boardDto.getContent() %></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
					<input type="submit" value="수정하기"/> &nbsp; | &nbsp;
					<input type="button" value="글삭제" onclick="window.location='game_bbs_delete.jsp?num=<%=num%>&pageNum=<%=pageNum%>' "/>&nbsp; | &nbsp;
					<input type="button" value="목록보기" onclick="window.location='game_bbs.jsp?id=<%=boardDto.getGame_id() %>&pageNum=<%=pageNum %>' "/>
				</td>
			</tr>
		</table>
	</form>
